...
DJISDKNode::initDataSubscribeFromFC()
{
                                                   ...
                                                   topicList50Hz, 1, 50))
  {
    ...
    {
      ROS_INFO("Success  to start 50Hz package! ");
      vehicle->subscribe->registerUserPackageUnpackCallback(
